...
void TestAMode0(); // Use Player Controller
void TestAMode1(); // Use Custom Controller
void TestAMode2(); // Use Custom Controller (Fast-forward)

void TestBMode0(); // Use Player Controller
void TestBMode1(); // Use Custom Controller
void TestBMode2(); // Use Custom Controller (Fast-forward)

void TestCMode0(); // Use Player Controller
void TestCMode1(); // Use Custom Controller
void TestCMode2(); // Use Custom Controller (Fast-forward)
...
int main() {
    ...
    int mode;
    std::cin >> mode;
    void (*a[])() = {TestAMode0, TestAMode1, TestAMode2};
    void (*b[])() = {TestBMode0, TestBMode1, TestBMode2};
    void (*c[])() = {TestCMode0, TestCMode1, TestCMode2};
...
void TestAMode0() { TestA(Mode::kPlayerController); }
void TestAMode1() { TestA(Mode::kCustomController); }
void TestAMode2() { TestA(Mode::kFastForwardingCustomController); }

void TestBMode0() { TestB(Mode::kPlayerController); }
void TestBMode1() { TestB(Mode::kCustomController); }
void TestBMode2() { TestB(Mode::kFastForwardingCustomController); }

void TestCMode0() { TestC(Mode::kPlayerController); }
void TestCMode1() { TestC(Mode::kCustomController); }
void TestCMode2() { TestC(Mode::kFastForwardingCustomController); }
